 ...
 */
public class CreateOtpPresenterImpl implements CreateOtpPresenter{
    CreateOtpView createOtpView;
    private CompositeSubscription subscription;
    @Inject
    UserInteractor userInteractor;

    @Override
    public void setView(CreateOtpView view) {
        createOtpView = view;
    }
    ...
    @Override
    public void createOtp(String token, String phone) {
        subscription.add(userInteractor.createOtp(token, phone)
                ...
                .subscribe(new Action1<Response<CommonApiResult>>() {
                    ...
                    public void call(Response<CommonApiResult> response) {
                        if (response.body().getErrorCode().equals(StatusCode.RESPONSE_ERROR_CODE_00)) {
                            createOtpView.onCreateOtpSuccsess(response.body());
                        } else {
                            createOtpView.onCreateOtpFailed(response.body().getErrorDesc());
                        }
                    }
                    ...
                    public void call(Throwable e) {
                        ...
                        createOtpView.onCreateOtpError(e);
                    }
                }));
    }
}
