...
public class DataStoreCurrentOfEnterpriseVpointResult extends CommonApiVpointResult {
    @SerializedName("data")
    @Setter
    @Getter
    private List<DataDetailSpecialVpointResult.DataListShopByNewResult.DataShop> dataShopResponses;
