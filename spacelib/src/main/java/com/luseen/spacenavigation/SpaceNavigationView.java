...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private CenterButtonImage centerButtonImage;
...
//        centreButton.setImageResource(centreButtonIcon);
        centreButton.setBackgroundResource(centreButtonIcon);
...
//            centreButton.getDrawable().setColorFilter(inActiveCentreButtonIconColor, PorterDuff.Mode.SRC_IN);
        ...
        // Create CenterButton Image
        centerButtonImage = new CenterButtonImage(context);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(mainContentHeight, mainContentHeight);
        centerButtonImage.setLayoutParams(layoutParams);
//        centreButton.setImageResource(centreButtonIcon);
        centerButtonImage.setImageResource(centreButtonIcon);

//        if (isCentreButtonIconColorFilterEnabled || isCentreButtonSelectable)
//            centreButton.getDrawable().setColorFilter(inActiveCentreButtonIconColor, PorterDuff.Mode.SRC_IN);

        centerButtonImage.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (spaceOnClickListener != null)
                    spaceOnClickListener.onCentreButtonClick();
        ...
        centerButtonImage.setOnLongClickListener(new OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (spaceOnLongClickListener != null)
                    spaceOnLongClickListener.onCentreButtonLongClick();
         ...
         */
        centreContent.addView(centerButtonImage, fabParams);
